...
class Customer(models.Model):
    _id=models.OneToOneField(User, unique=True,  on_delete=models.CASCADE,default=0)
    ...
    address = models.CharField(max_length=25,null=False,default="first street")
    postal_code = models.IntegerField(null=False,default=20100)
