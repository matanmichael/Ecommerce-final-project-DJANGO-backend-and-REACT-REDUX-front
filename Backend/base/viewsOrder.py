...
from .Serailizers import OrderSerializer,Order_detailSerializer,CustomerSerializer
from .models import Order, Order_detail, Product,Customer
...
def addOrder(request):
    ...
    return Response("order was create successfully")
